 ...
 * @param {string} opts.coin[='btcz'] - The coin for this wallet
 ...
 * @param {string} opts.coin[='btcz'] - The expected coin for this wallet
...
WalletService.prototype.savePreferences = function(opts, cb) {
  ...
  var preferences = [{
    ...
    name: 'unit',
    isValid: function(value) {
      return _.isString(value) && _.includes(['btcz', 'bit'], value.toLowerCase());
    },
  }];
 ...
 * @param {Object} opts
 * @param {String} [opts.coin='btcz'] (optional)
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'btcz'] - The coin to estimate fee levels from.
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'btcz'] - The coin for this transaction.
