...
describe('Address', function() {
  ...
  describe('#derive', function() {
    ...
    it('should derive 1-of-1 P2SH address', function() {
      ...
      should.exist(address);
      address.walletId.should.equal('wallet-id');
      address.address.should.equal('t1UYbVbhAtho2eTh8z5TK6pot9hKLQhbLig');
      address.network.should.equal('livenet');
      address.isChange.should.be.false;
      address.path.should.equal('m/133/0');
      address.type.should.equal('P2SH');
    });
    it('should derive 1-of-1 P2PKH address', function() {
      ...
      should.exist(address);
      address.walletId.should.equal('wallet-id');
      address.address.should.equal('t1fVxpmE1JvNT8XbK2TYR4z7SBPyU7NEmTq');
      address.network.should.equal('livenet');
      address.isChange.should.be.true;
      address.path.should.equal('m/133/2');
